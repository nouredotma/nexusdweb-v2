      ...
      <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex flex-row gap-2 mt-4 w-full">
          ...
          <button 
            ...
            className="flex-3 min-w-fit flex items-center justify-between h-12 md:h-14 px-3 md:px-4 rounded-full border-2 border-neutral-200 hover:border-[#25D366] bg-white text-black font-bold transition-all duration-300 whitespace-nowrap cursor-pointer text-left"
          >
            <div className="flex items-center gap-1.5 md:gap-3">
              ...
              <span className="text-xs md:text-base">WhatsApp</span>
            </div>
          </button>
        </div>
